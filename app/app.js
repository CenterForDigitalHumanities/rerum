...
rerum.value('API_Path', 'http://165.134.241.141/annotationstore/anno/'); //Store this like a global variables for use throughout, that way we only have to change it here. 
