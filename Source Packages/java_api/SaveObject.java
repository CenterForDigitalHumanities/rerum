 ...
 * @author bhaberbe
 */
public class SaveObject extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            URL postUrl = new URL(Java_Constants.ANNOTATION_SERVER_ADDR + "/anno/saveNewAnnotation.action");
    ...
    public String getServletInfo() {
        return "Save an object into the data store.  This will detect whether it should be a save or update inside the Servlet.action";
    }// </editor-fold>
