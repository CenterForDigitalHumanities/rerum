 ...
 * @author bhaberbe
 */
public class BulkSaveObjects extends HttpServlet {

    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            URL postUrl = new URL(Java_Constants.ANNOTATION_SERVER_ADDR + "/anno/batchSaveMetadataForm.action");
    ...
    public String getServletInfo() {
        return "Save many new objects into the data store.  The Servlet.action will perform a save/update on an item by item basis "
                + "(if an item contains an @id that exists in the store, an update will be performed.)";
    }
