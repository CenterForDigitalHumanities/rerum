...
rerum.value('Backend_ip', '165.134.156.141'); //Store this like a global variables for use throughout, that way we only have to change it here. 
rerum.value('API_Path', 'http://165.134.156.141/annotationstore/anno/'); //Store this like a global variables for use throughout, that way we only have to change it here. 
